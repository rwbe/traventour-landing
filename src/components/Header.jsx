    ...
    <div className="absolute top-14 right-16 lg:right-44 bg-white border border-gray-300 p-4 rounded-lg shadow-lg w-52 z-10">
      ...
      <ul className="space-y-1">
        {languages.map((lang, index) => (
          <li
            key={index}
            className="flex items-center cursor-pointer hover:bg-blue-600 hover:text-white transition-colors duration-200 rounded p-2"
      ...
      <AnimatePresence>
        {openMobileMenu && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -50 }}
            className="container fixed z-50 flex flex-col items-center justify-center w-full h-auto py-4 bg-white mt-14"
          >
            <a
              href="#"
              className="inline-flex justify-center w-full px-4 py-2 font-semibold text-white bg-blue-600 rounded-md"
            >
              Início
            </a>
      ...
      <nav className="container flex items-center justify-between mb-4 lg:flex border-t-transparent">
        ...
        <div className="flex text-gray-600 font-medium items-center gap-6 mt-4">
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ? 'text-blue-600 font-bold hover:bg-gray-200 rounded-full p-2 transition-colors duration-200'
                : 'hover:bg-gray-200 rounded-full p-2 transition-colors duration-200'
            }
          >
            Início
          </NavLink>
          <a
            href="#about-us"
            className="hover:bg-gray-200 rounded-full p-2 font-medium text-gray-600 transition-colors duration-200"
          >
            Sobre nós
          </a>
          <a
        ...
        <div className="flex items-center gap-8 relative">
          ...
          <div className="flex items-center mt-4">
            ...
            />
            <p className="text-md font-medium ml-2 cursor-pointer" onClick={toggleLanguageSelector}>
              Português
            </p>
